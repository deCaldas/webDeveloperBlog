...
El **participio pasado** es **la forma verbal no personal** que, en español, suele terminar en **-ado**, **-ido**, o ser irregular (hecho, dicho, visto). En inglés, es la **forma del verbo que se utiliza para construir los tiempos compuestos (los perfectos) y la [voz pasiva](_09-passiveVoice)**.

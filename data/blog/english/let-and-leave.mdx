...
*   **LEAVE** puede ir seguido de un objeto (alguien o algo) y un lugar, o un objeto y un adjetivo/participio.
    *   **Fórmula:** `Leave + Alguien + Lugar`.
    *   *Ejemplo:* "Leave **the children in the garden**."
    *   **Fórmula:** `Leave + Algo + Lugar`.
    *   *Ejemplo:* "Leave **the book on the table**."
    *   **Fórmula:** `Leave + Algo + Adjetivo`.
    *   *Ejemplo:* "I leave **the window open**."
    *   **Fórmula:** `Left + Algo + Participio Pasado`.
    *   *Ejemplo:* "I left **the car washed and polished**."
    *   **Fórmula:** `Left + Algo + Participio Presente`.
